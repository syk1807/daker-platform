import { HackathonSummary, HackathonDetail } from "@/types";
...
export const hackathonDetails: HackathonDetail[] = [
  ...
  },
  {
    ...
    sections: {
      overview: {
        summary:
          "바이브 코딩 경험을 개선하는 창의적인 AI 아이디어를 제안하세요. 실현 가능성과 참신함을 함께 평가합니다.",
        teamPolicy: { allowSolo: true, maxTeamSize: 5 },
      },
      info: {
        notice: [
          "아이디어 기반 공모전으로, 코드 제출은 필수가 아닙니다.",
          "발표 자료(PDF)와 시연 영상(선택)을 제출합니다.",
        ],
        links: { rules: "#", faq: "#" },
      },
      eval: {
      ...
      schedule: {
        timezone: "Asia/Seoul",
        milestones: [
          { name: "접수/기획서 제출 기간", at: "2026-02-01T10:00:00+09:00" },
          { name: "접수/기획서 제출 마감", at: "2026-03-03T10:00:00+09:00" },
          { name: "최종 PDF 제출 마감", at: "2026-03-06T10:00:00+09:00" },
          { name: "투표평가 시작", at: "2026-03-06T12:00:00+09:00" },
          { name: "투표평가 마감", at: "2026-03-09T10:00:00+09:00" },
        ],
      },
      prize: {
        items: [
      ...
      leaderboard: {
        publicLeaderboardUrl:
          "/hackathons/monthly-vibe-coding-2026-02#leaderboard",
